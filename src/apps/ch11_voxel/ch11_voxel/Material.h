...
inline PhongMaterial_glsl makePhongMaterial(math::hdr::Rgba_f aDiffuseColor,
                                            math::hdr::Rgba_f aSpecularColor = math::hdr::gWhite<float>)
{
    return PhongMaterial_glsl{
        .mAmbientColor = aDiffuseColor,
        .mDiffuseColor = aDiffuseColor,
        .mSpecularColor = aSpecularColor,
    };
}
